...
iterr = 1000
#figure name
figname1 = "RTV600mVCurrent20;700-800sn%d" % n
# figname2 = "result__foldernameanalysis1_3d_scatterplot"
figname3 = "RTV600mVCurrent19;20;700-800s;n16analysis1_colormapplot_1"
# figname4 = "result__analysis1_colormapplot_2"

script_dir = os.path.dirname(__file__)
results_dir = os.path.join(script_dir, 'RTV600mVCurrent20;700-800s;n16/')
if not os.path.isdir(results_dir):
    os.makedirs(results_dir)

"Output Data"
f = open(results_dir + 'RTV600mVCurrent20;700-800s;n16;output.txt','w')
sys.stdout = f

"Import data from excel file"
from xlrd import open_workbook
book = open_workbook('Data7_RTV600mV.xlsx')
