...
iterr = 171
#figure name
figname1 = "RTV300mVCurrent1;n16;iter1000n%d" % n
# figname2 = "result__foldernameanalysis1_3d_scatterplot"
figname3 = "RTV300mVCurrent1;n16;iter1000analysis1_colormapplot_1"
# figname4 = "result__analysis1_colormapplot_2"

script_dir = os.path.dirname(__file__)
results_dir = os.path.join(script_dir, 'RTV300mVCurrent1;n16;iter171/')
if not os.path.isdir(results_dir):
    os.makedirs(results_dir)

"Output Data"
f = open(results_dir + 'RTV300mVCurrent1;n16;iter1000;output.txt','w')
sys.stdout = f
